    ...
    <AuthLayout mode="signup">
      <div className="fade-up">
        ...
        <p className="mt-3 text-[#6d6660]">
          Your first automated workflow is a few clicks away.
        </p>
        <form onSubmit={submit} className="mt-8 space-y-5">
          ...
          <button
            disabled={loading}
            className="w-full rounded-xl bg-[#ff4f00] px-5 py-3.5 font-bold text-white hover:bg-[#d94100] disabled:opacity-60"
          >
